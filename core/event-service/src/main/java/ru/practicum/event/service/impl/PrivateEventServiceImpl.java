...
public class PrivateEventServiceImpl implements PrivateEventService {
    ...
    public Event createEvent(Long userId, NewEventDto dto, UserDto user) {
        ...
        CategoryDto category = categoryApiClient.getCategory(dto.getCategory());
        validateEventDate(dto.getEventDate());
        Event event = EventMapper.toEvent(dto, category.getId(), user);
    ...
    public Event updateUserEvent(Long userId, Long eventId, UpdateEventUserRequest dto) {
        ...
        if (dto.getCategory() != null) {
            categoryApiClient.getCategory(dto.getCategory());
    ...
    private void validateEventDateIfPresent(LocalDateTime eventDate) {
        if (eventDate != null) validateEventDate(eventDate);
    }
    ...
    private void applyUpdateFields(Event event, UpdateEventUserRequest dto, Long categoryId) {
